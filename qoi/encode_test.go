...
func TestEncode(t *testing.T) {
	...
	qoiFile, err := os.OpenFile("testencode.qoi", os.O_CREATE|os.O_TRUNC|os.O_WRONLY, 0644)
	...
	qoiFile, err = os.Open("testencode.qoi")
	...
	imaging.Save(qoiImg, "testencode.png")
	require.Equalf(t, pngImg, qoiImg, "The image was not encoded properly")
}
